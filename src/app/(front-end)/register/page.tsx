...
import { UserSignupForm } from "@/components/front-end/user-signup-form";
...
export default async function RegisterPage() {
  ...
  return (
    <div className='dark:bg-primary-foreground h-screen items-center flex justify-center border-b border-white/10'>
      <div className='mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px] md:w-1/3'>
